...
public final class ServerMessageEvents {
	...
	public interface AllowChatMessage {
		 ...
		 * @param params the {@link class_2556.class_7602}
		 * @return {@code true} if the message should be broadcast, otherwise {@code false}
		 */
		boolean allowChatMessage(class_7471 message, class_3222 sender, class_2556.class_7602 params);
	}
	...
	public interface AllowGameMessage {
		 ...
		 * @return {@code true} if the message should be broadcast, otherwise {@code false}
		 */
		boolean allowGameMessage(MinecraftServer server, class_2561 message, boolean overlay);
	}
	...
	public interface AllowCommandMessage {
		 ...
		 * @return {@code true} if the message should be broadcast, otherwise {@code false}
		 */
		boolean allowCommandMessage(class_7471 message, class_2168 source, class_2556.class_7602 params);
	}
	...
	public interface ChatMessage {
		 ...
		 * @param params the {@link class_2556.class_7602}
		 */
		void onChatMessage(class_7471 message, class_3222 sender, class_2556.class_7602 params);
	}
	...
	public interface GameMessage {
		 ...
		 * @param overlay {@code true} when the message is an overlay
		 */
		void onGameMessage(MinecraftServer server, class_2561 message, boolean overlay);
	}
	...
	public interface CommandMessage {
		 ...
		 * @param params the {@link class_2556.class_7602}
		 */
		void onCommandMessage(class_7471 message, class_2168 source, class_2556.class_7602 params);
	}
}
